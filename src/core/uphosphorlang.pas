...
const
  ...
  SignatureNames: array[0..1135] of String = (
    ...
    'asin', 'asinh', 'at$', 'atan', 'atan2', 'atanh', 'aucase$',
    'base64_decode$', 'base64_decodefile', 'base64_encode$',
    'base64_encodefile$', 'base64_error', 'base64_urldecode$',
    'base64_urlencode$', 'base64_valid', 'bevel@', 'bevel_shape',
    'bevel_shape@', 'bevel_style', 'bevel_style@', 'bg$', 'bin$', 'bitbtn@',
    'bitbtn_caption$', 'bitbtn_caption@', 'bitbtn_click@', 'bitbtn_onclick@',
    'bitmap@', 'bitmap_height', 'bitmap_pixel', 'bitmap_width', 'blink$',
    'bold$', 'buffer_clone@', 'buffer_copy', 'buffer_equal', 'buffer_fill',
    ...
    'calendar_date', 'calendar_date@', 'camerapath$', 'canvas_arc@',
    'canvas_brushcolor@', 'canvas_clear@', 'canvas_ellipse@',
    'canvas_fillrect@', 'canvas_fontcolor@', 'canvas_fontsize@',
    'canvas_line@', 'canvas_lineto@', 'canvas_moveto@', 'canvas_pencolor@',
    'canvas_penwidth@', 'canvas_pie@', 'canvas_polygon@', 'canvas_polyline@',
    'canvas_rectangle@', 'canvas_roundrect@', 'canvas_textheight',
    'canvas_textout@', 'canvas_textwidth', 'center$', 'cfg_autosave@',
    ...
    'classname$', 'clreol$', 'clreos$', 'cls$', 'cmpval', 'color', 'color$',
    'colorbutton@', 'colorbutton_color', 'colorbutton_color@', 'colordialog@',
    'colordialog_color', 'colordialog_color@', 'colortostr$', 'combo_add@',
    'combo_clear@', 'combo_count', 'combo_item$', 'combo_itemindex',
    'combo_itemindex@', 'combo_onchange@', 'combo_text$', 'combobox@',
    'containsstr', 'containstext', 'control_align', 'control_align@',
    'control_anchors$', 'control_anchors@', 'control_bold', 'control_bold@',
    'control_bounds@', 'control_bringtofront@', 'control_color',
    'control_color@', 'control_cursor', 'control_cursor@', 'control_enabled',
    'control_enabled@', 'control_focused', 'control_fontcolor',
    ...
    'crt_hideconsole', 'crt_init', 'crt_showconsole', 'date', 'date$',
    ...
    'dict_typename$', 'dict_typeof', 'dict_typeof$', 'dim@', 'dir_copy',
    'dir_create', 'dir_delete', 'dir_exists', 'dir_getcreationtime',
    'dir_getcurrent$', 'dir_getdirectories$', 'dir_getentries$',
    'dir_getfiles$', 'dir_getlastaccesstime', 'dir_getlastwritetime',
    'dir_getparent$', 'dir_isempty', 'dir_isrelativepath', 'dir_move',
    'dir_setcreationtime', 'dir_setcurrent', 'dir_setlastaccesstime',
    'dir_setlastwritetime', 'dirseparator$', 'documentspath$',
    'downloadspath$', 'drawgrid@', 'drawgrid_col', 'drawgrid_colcount',
    'drawgrid_colcount@', 'drawgrid_cursor@', 'drawgrid_drawcell@',
    'drawgrid_fixedcols', 'drawgrid_fixedcols@', 'drawgrid_fixedrows',
    'drawgrid_fixedrows@', 'drawgrid_ondrawcell@', 'drawgrid_row',
    'drawgrid_rowcount', 'drawgrid_rowcount@', 'edit@', 'edit_clear@',
    'edit_maxlength', 'edit_maxlength@', 'edit_onchange@', 'edit_readonly',
    'edit_readonly@', 'edit_selectall@', 'edit_text$', 'edit_text@',
    'encodedate', 'endsstr', 'endstext', 'environ$', 'erl', 'err',
    'err_clear', 'errmsg$', 'error', 'exp', 'extractfileext$',
    'extractfilename$', 'extractfilepath$', 'faint$', 'file_appendalltext',
    'file_copy', 'file_createempty', 'file_delete', 'file_exists',
    'file_getcreationtime', 'file_getlastaccesstime', 'file_getlastwritetime',
    'file_getsize', 'file_move', 'file_readallbytes@', 'file_readalltext$',
    ...
    'fontdialog_fontsize', 'fontdialog_fontsize@', 'forcedirectories',
    ...
    'formatsettings', 'formatsettings$', 'frac', 'funcexists?', 'getkey$',
    'gettime', 'groupbox@', 'groupbox_caption$', 'groupbox_caption@',
    'gui_clearerror', 'gui_error', 'guidfilename$', 'gzip_compress$',
    'gzip_compressfile', 'gzip_csize', 'gzip_decompress$',
    'gzip_decompressfile', 'gzip_error', 'gzip_ratio', 'gzip_size',
    ...
    'http_strerror$', 'http_timeout', 'http_urldecode$', 'http_urlencode$',
    'http_useragent', 'http_useragent$', 'http_validatessl',
    'http_verify_peer', 'idletimer@', 'image@', 'image_center',
    'image_center@', 'image_empty', 'image_load@', 'image_picheight',
    'image_picwidth', 'image_proportional', 'image_proportional@',
    'image_setbitmap@', 'image_stretch', 'image_stretch@', 'imagelist@',
    'imagelist_addbitmap', 'imagelist_addfile', 'imagelist_attach@',
    ...
    'incmillisecond', 'incminute', 'incmonth', 'incsecond', 'incweek',
    'incyear', 'inkey$', 'inputbox$', 'insert$', 'instr', 'instrrev', 'int',
    'inverse$', 'ioerror', 'iostrerror$', 'isalnum', 'isalpha', 'isam',
    'isassigned', 'isdigits', 'isinfinite', 'isinleapyear', 'islower',
    'isnan', 'isnull', 'isnumeric', 'ispm', 'issameday', 'isspace', 'istoday',
    'isupper', 'italic$', 'json_array@', 'json_bool@', 'json_clone@',
    'json_count', 'json_get@', 'json_getb', 'json_getn', 'json_gets$',
    'json_has', 'json_isarr', 'json_isbool', 'json_isnull', 'json_isnum',
    'json_isobj', 'json_isstr', 'json_item@', 'json_itemb', 'json_itemn',
    'json_items$', 'json_keys@', 'json_len', 'json_merge@', 'json_null@',
    'json_number@', 'json_object@', 'json_parse@', 'json_path@', 'json_pathb',
    'json_pathn', 'json_paths$', 'json_pop@', 'json_pretty$', 'json_push@',
    'json_pushb@', 'json_pushn@', 'json_pushnull@', 'json_pushs@',
    'json_pushval@', 'json_remove@', 'json_removeat@', 'json_set@',
    'json_setb@', 'json_setn@', 'json_setnull@', 'json_sets@', 'json_setval@',
    'json_string@', 'json_stringify$', 'json_type', 'json_typename$',
    'json_value', 'json_value$', 'keypressed', 'kill', 'label@',
    'label_caption$', 'label_caption@', 'lbound', 'lcase$', 'left$', 'len',
    'lfill$', 'librarypath$', 'line$', 'list_add@', 'list_clear@',
    'list_count', 'list_item$', 'list_itemindex', 'list_itemindex@',
    'list_onclick@', 'list_selected$', 'listbox@', 'listitem@',
    'listitem_caption$', 'listitem_caption@', 'listitem_subitem$',
    'listitem_subitem@', 'listview@', 'listview_addcolumn@',
    'listview_itemcount', 'ln', 'log10', 'log2', 'ltab$', 'ltrim$',
    'mainmenu@', 'maskedit@', 'maskedit_mask$', 'maskedit_mask@',
    'maskedit_text$', 'maskedit_text@', 'max', 'memo@', 'memo_addline@',
    'memo_clear@', 'memo_line$', 'memo_linecount', 'memo_onchange@',
    'memo_readonly', 'memo_readonly@', 'memo_text$', 'memo_text@',
    'memo_wordwrap', 'memo_wordwrap@', 'menuitem@', 'menuitem_caption$',
    'menuitem_caption@', 'menuitem_click@', 'menuitem_onclick@', 'mid$',
    'millisecondof', 'millisecondsbetween', 'millisecondspan', 'min',
    'minuteof', 'minutesbetween', 'minutespan', 'mkdir', 'monthof',
    'monthoftheyear', 'monthsbetween', 'monthspan', 'movedown$', 'moveleft$',
    'moveright$', 'moveup$', 'moviespath$', 'msgbox', 'msgbox_confirm',
    'mulstring$', 'musicpath$', 'narr_get', 'narr_set@', 'ndims', 'now',
    'number', 'oct$', 'opendialog@', 'openfile$', 'openpicture$', 'opentext$',
    'os_architecture$', 'os_build', 'os_check', 'os_major', 'os_minor',
    'os_name$', 'os_platform$', 'os_spmajor', 'os_spminor', 'pagecontrol@',
    'pagecontrol_pagecount', 'pagecontrol_pageindex',
    ...
    'path_matchespattern', 'pathseparator$', 'pause', 'pdict@', 'pdict_get@',
    'pdict_getdef@', 'pdict_set@', 'pdim@', 'picturespath$', 'pnttonum',
    'pointer@', 'popupmenu@', 'popupmenu_attach@', 'processmessages',
    'progressbar@', 'progressbar_max', 'progressbar_max@', 'progressbar_min',
    'progressbar_min@', 'progressbar_position', 'progressbar_position@',
    'proper$', 'publicpath$', 'radio_caption$', 'radio_caption@',
    'radio_checked', 'radio_checked@', 'radio_onchange@', 'radiobutton@',
    'radiogroup@', 'radiogroup_add@', 'radiogroup_caption$',
    'radiogroup_caption@', 'radiogroup_clear@', 'radiogroup_count',
    'radiogroup_item$', 'radiogroup_itemindex', 'radiogroup_itemindex@',
    ...
    'randomize', 'regex_find$', 'regex_findall@', 'regex_findlen',
    'regex_findpos', 'regex_group$', 'regex_groupcount', 'regex_groups@',
    'regex_split@', 'replacestr$', 'replacetext$', 'reset$', 'restorepos$',
    'reverse$', 'rfill$', 'right$', 'ringtonespath$', 'rmdir', 'rnd', 'round',
    'rtab$', 'rtrim$', 'sandboxroot$', 'sarr_get$', 'sarr_set@',
    'savedialog@', 'savefile$', 'savepicture$', 'savepos$', 'savetext$',
    'scrollbar@', 'scrollbar_max', 'scrollbar_max@', 'scrollbar_min',
    'scrollbar_min@', 'scrollbar_position', 'scrollbar_position@',
    'scrollbox@', 'sdict@', 'sdict_get$', 'sdict_getdef$', 'sdict_set@',
    'sdim@', 'secondof', 'secondsbetween', 'secondspan', 'selectdir$',
    'selectdirdialog@', 'sgn', 'shape@', 'shape_brushcolor',
    'shape_brushcolor@', 'shape_kind', 'shape_kind@', 'shape_pencolor',
    'shape_pencolor@', 'sharedalarmspath$', 'sharedcamerapath$',
    'shareddocumentspath$', 'shareddownloadspath$', 'sharedmoviespath$',
    'sharedmusicpath$', 'sharedpicturespath$', 'sharedringtonespath$',
    'showcursor$', 'sign', 'sin', 'sinh', 'space$', 'speedbutton@',
    'speedbutton_caption$', 'speedbutton_caption@', 'speedbutton_click@',
    'speedbutton_down', 'speedbutton_down@', 'speedbutton_groupindex@',
    'speedbutton_onclick@', 'spinedit@', 'spinedit_max@', 'spinedit_min@',
    'spinedit_onchange@', 'spinedit_value', 'spinedit_value@', 'splitter@',
    'sqlite_available', 'sqlite_backup', 'sqlite_begin', 'sqlite_bindjson',
    'sqlite_bindnull', 'sqlite_bindnum', 'sqlite_bindstr', 'sqlite_changes',
    'sqlite_clearbind', 'sqlite_clearerror', 'sqlite_close',
    'sqlite_colcount', 'sqlite_colindex', 'sqlite_colname$', 'sqlite_coltype',
    'sqlite_coltypename$', 'sqlite_columns@', 'sqlite_commit', 'sqlite_eof',
    'sqlite_error', 'sqlite_errormsg$', 'sqlite_escape$', 'sqlite_exec',
    'sqlite_fetchall@', 'sqlite_fetchone@', 'sqlite_finalize', 'sqlite_getn',
    'sqlite_getnum', 'sqlite_gets$', 'sqlite_getstr$', 'sqlite_insertjson',
    'sqlite_intrans', 'sqlite_isblob', 'sqlite_isn', 'sqlite_isnull',
    'sqlite_isopen', 'sqlite_lastid', 'sqlite_open@', 'sqlite_path$',
    'sqlite_prepare@', 'sqlite_query$', 'sqlite_query@', 'sqlite_quote$',
    'sqlite_reset', 'sqlite_rollback', 'sqlite_row@', 'sqlite_scalar',
    'sqlite_scalar$', 'sqlite_step', 'sqlite_strerror$', 'sqlite_tableexists',
    'sqlite_tables@', 'sqlite_totalchanges', 'sqlite_updatejson',
    'sqlite_vacuum', 'sqlite_version$', 'sqr', 'startsstr', 'startstext',
    'statictext@', 'statictext_caption$', 'statictext_caption@', 'statusbar@',
    'statusbar_text$', 'statusbar_text@', 'str$', 'strchar$', 'strcmp',
    'strcmpi', 'strerror', 'stri$', 'string$', 'stringgrid@',
    ...
    'trackbar_onchange@', 'trackbar_position', 'trackbar_position@',
    'trayicon@', 'trayicon_hide@', 'trayicon_hint$', 'trayicon_hint@',
    'trayicon_onclick@', 'trayicon_show@', 'trayicon_visible', 'treenode@',
    'treenode_caption$', 'treenode_caption@', 'treenode_childcount',
    'treeview@', 'treeview_nodecount', 'trim$', 'ubound', 'ucase$',
    'underline$', 'unzip_count', 'unzip_entry$', 'unzip_extract', 'updown@',
    'updown_max', 'updown_max@', 'updown_min', 'updown_min@',
    'updown_position', 'updown_position@', 'val', 'valcode', 'weekof',
    'weekofthemonth', 'weekoftheyear', 'weeksbetween', 'weeksinayear',
    'weeksinyear', 'weekspan', 'word$', 'wordcount', 'yearof', 'yearsbetween',
    'yearspan', 'yesterday', 'zip_addfile', 'zip_addstr', 'zip_close',
    'zip_compress', 'zip_count', 'zip_create@', 'zip_entrysize', 'zip_error',
    'zip_exists', 'zip_extract', 'zip_extractall', 'zip_list$', 'zip_open@',
    'zip_quick', 'zip_read$'
  );
  ...
  SignatureCodes: array[0..1135] of String = (
    ...
    '@', '@', '@n', '@', '@n', 'n', 'n', '@', '@', '@$', '@', '@$', 'nn', '@',
    '@nn', '@', '', '', '@', '@n@nn', '@@', '@n', '@nnn', '@', '$', '@n',
    '@n', '@nn|@nn?', '@n', '@nn|@nn?', '@$|@$n', '@', 'n', '@n', '@nn',
    '@nn', '@nn%|@nnn|@nn%?|@nnn?', '@nn', '@nn', '@', '@n$', '@', '@', '@$',
    '@', '@$', '$n', '$', '$nn', 'n', '', '@', '@', '@n', '', '@nnnnnn', '@n',
    '@', '@nnnn', '@nnnn', '@n', '@n', '@nnnn', '@nn', '@nn', '@n', '@n',
    '@nnnnnn', '@$', '@$', '@nnnn', '@nnnnnn', '@$', '@nn$', '@$', '$n|$nn',
    '@n', '@', '@$$', '@$', '@$$', '@', '@$$$', '@$$n', '@$n', '@$$n', '@$n',
    '@$$', '@$', '@$', '@$', '@', '$', '$', '', '@', '@', '@$', '@$', '@',
    '@', '@$$$', '@$$n', '@$n', '@$$n', '@$n', '@$$', '$$', '$', '@', '@',
    '@$', '@', '@n', '@$', '@|@$', '@$', '@', '@$', '@n', '@nn', '@', '@',
    ...
    'n', 'n', '$n', '$', '@', '@', '@', '@$', '@', '@$', 'nn', '@', '@$', '@',
    '@n', '@', '@$', '@', '@n', '@', '@$', '@', '@n', '@|@$', '@', '@$', '@',
    '@$', '$n|$nn', 'n', 'nn', 'nn', 'nn', 'n', 'nn', 'nn', '$', 'n', 'n',
    'nn', 'nn', 'n', 'n', 'n', 'n', '', '$|$$', '$', '$n', '', '@n|@nn|@nnn',
    '@nn|@nnn|@nnnn', '@', '', '@', 'n', '', '|$', '|$', '$$', '', '',
    'nn|nnn', '', '', '', '', '', '', '@', '@', '@', '@n', '@', '@$', '@',
    '@', '@$', '', 'n', '@n', '@n@', '', '$$', '$$|$$$', '$', '$', '$', '$',
    '$', '$', '$', '$', '$', '$', '$', '$$|$$n', '', 'n', '', '@$', '@$@',
